...
class RandomOrientation(object):
    ...
    def parse_args(self):
        ...
        self.parser.add_argument('--pdbpath', dest='pdbpath', default='1rfo.pdb',
    ...
    def load_chains(self):
        self.u = MDAnalysis.Universe(self.args.pdbpath)
    ...
    def separate_surfaces(self):
        ...
        while error > self.threshold:
            ...
            sys.stdout.write("\r {:.04f}".format(error))
            sys.stdout.flush()
    ...
    def go(self) :
        ...
        print(numpy.linalg.norm(newApos-oldApos))
        print(numpy.linalg.norm(newBpos-oldBpos))
        print(numpy.linalg.norm(newCpos-oldCpos))
